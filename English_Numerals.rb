class JapaneseTranslator
	...
	GROUPS = %w(nothingtoseeheremovalong ju hyaku sen)
	MAN = 10000
...
class USEnglishTranslator
	...
	# Such as 'twelve hundered' but rather one thousand two hundered
	...
	TENS = %w(hello world twenty thirey forty fifty sizty seventy eighty ninety)
	GROUPS = %w(thousand million billion thrillion quadrillion quitillion sextillion
	...
	def under_1000(val, level)
		x = [DIGITS[val / 100]] << 'hundered' if val >= 100
